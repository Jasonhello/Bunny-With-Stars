...
var emptyS, oneS, twoS, starDisplay;
...
function preload()
{
  ...
  emptyS = loadImage("empty.png");
  oneS = loadImage("one_star.png");
  twoS = loadImage("stars.png");
...
function setup() 
{
  ...
  blower.position(270, 320);
  blower.size(100,130);
  blower.mouseClicked(airBlow);

  starDisplay = createSprite(60,30);
  starDisplay.addAnimation("empty", emptyS);
  starDisplay.addAnimation('one', oneS);
  starDisplay.addAnimation("two", twoS);
...
function draw() 
{
  ...
  if(collide(fruit, star2, 30)){
    star2.visible = false;
    starDisplay.changeImage("two");
    gStar.play()
  }
